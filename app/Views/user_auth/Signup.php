                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <input type="email" id="numScheda" class="form-control form-control-lg" placeholder="Inserisci Numero Scheda Elettorale" />
                                </div>

                                <div class="form-outline form-white mb-4">
                                    <label class="form-label" for="numScheda">Nome</label>
                                    <input type="text" id="nome" class="form-control form-control-lg" placeholder="Inserisci Nome" />
                                </div>
                                ...
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <input type="text" id="cognome" class="form-control form-control-lg" placeholder="Inserisci Cognome" />
                                </div>

                                <div class="form-outline form-white mb-4">
                                    <label class="form-label" for="numScheda">Età</label>
                                    <input type="number" id="eta" class="form-control form-control-lg" placeholder="Inserisci Età" />
                                </div>
